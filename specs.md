...
* **Phase 3**: Compare the obtained results in terms of: model accuracy in simulation; time required to perform the training; model complexity: number of parameters and FLOPS to perform the output sample prediction. o
